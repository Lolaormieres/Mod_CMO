...
fig, ax = (x_expe-x_ref).cartoplot(projection=crs,plot_method='scatter',minmax=MINMAX,colormap='seismic')
...
fig.savefig('Compar_'+str(expe)+'-'+str(xpref)+'_'+str(date)[0:10]+'-'+str(date)[11:13]+str(cterm_for)+'difftest_'+str(var)+'.watt.png')
