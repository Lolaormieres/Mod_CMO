...
# directory
Dir ="/home/ormieresl/Routines/DF_SST_vf/DF_SST_vf_mapfactor_corrige"
...
expe = ['GL55','GKOR','GKPH', 'GMOT', 'GM6E','GN84','GO4A','GNSR','GOJQ']
expe_mer = ['GL55','GKOR','GKPH', 'GMOT', 'GM6E','GN84','GO4A','GNSR','GOJQ']
#expe = ['GNYG']
#expe_mer = ['GNYG']
# =============================================================================
            ...
            try:
                ...
                for i in range(len(name)):
                    ...
                    for key in zones.keys():
                      ...
                      variance      = sgmeandm(ecart,map_factor,mask=mask)
                      f_diff_std    = np.sqrt(variance)
                      #temp
                      SST_xp   = sgmeandm(SST_xp_tot.data,map_factor,mask)
                      SST_mer  = sgmeandm(SST_mer_tot.data,map_factor,mask)
