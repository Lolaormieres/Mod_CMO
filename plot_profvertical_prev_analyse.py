...
for i in range(len(name)):
    ...
    #avec extract    
    f_pt=f.extract_point(lon_pt,lat_pt)
    f_pt=f_pt.data
    f_mer_pt=f_mer.extract_point(lon_pt,lat_pt)
    f_mer_pt=f_mer.data
    f_mer_init_pt=f_mer_init.extract_point(lon_pt,lat_pt)
    f_mer_init_pt=f_mer_init_pt.data
    f_for_pt=f_for.extract_point(lon_pt,lat_pt)
    f_for_pt=f_for_pt.data
    f_for_init_pt=f_for_init.extract_point(lon_pt,lat_pt)
    f_for_init_pt=f_for_init_pt.data
    f_anaprod_pt=f_anaprod.extract_point(lon_pt,lat_pt)
    f_anaprod_pt=f_anaprod_pt.data
    ...
    # f_anaprod_pt=[f_anaprod_total[0,6]]
