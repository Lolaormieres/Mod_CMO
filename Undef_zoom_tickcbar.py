...
f_diff = r_cmo.readfield(name[0])  #CMO
f_diff = r.readfield(name_mer[0]) - 273.15 #Mercator
...
# ax.gridlines()
# plt.show()
# fig.savefig(chemin_undef+name[0]+'_'+str(expe)+'-'+'_'+str(date)[0:10]+'-'+str(date)[11:13]+'-SST_MER-'+cblock+'-'+ckind+str(term)+'_test.png')
