...
for e in expe:
    print(e)
    df_e = pd.read_csv('DF_SST_vf/'+str(e)+'_'+str(zone_GK7C)+'_'+str(compar)+'_sst.csv')
    df_e.head()
    df_e.dtypes
    
    
    
    # df_e=df_GL55.loc[((df_GL55['expe']==e) & (df_GL55['var']==niv))][['date','expe','var','level','biais','eqm','ech','zone','compar']] #& (df_an['var']==niv)[['date','expe','var','level','biais','eqm','ech','zone','compar']]]
    # print(df_e)
...
compar='an-mer'
df_an = pd.read_csv('DF_SST_decembre/septembre_octobre_'+str(compar)+'_sst_'+str(zone_GK7C)+'_96.csv')
df_an.head()
df_an.dtypes


df_new = pd.read_csv('DF_SST_8/'+str(zone_GK7C)+str(compar)+'_sst.csv')
df_new.head()
df_new.dtypes

## nord_atlantiquean-mer_sst.csv

df_GL55 = pd.read_csv('DF_SST_6/septembre_octobre_'+str(compar)+'_sst_'+str(zone_GK7C)+'.csv')
df_GL55.head()
df_GL55.dtypes
...
df_GKCJ.head()
df_GKCJ.dtypes ## que EURAT pour linstant
...
xp='GL55'
df_GL55=df_GL55.loc[((df_GL55['expe']==xp) & (df_GL55['var']==niv))][['date','expe','var','level','biais','eqm','ech','zone','compar']] #& (df_an['var']==niv)[['date','expe','var','level','biais','eqm','ech','zone','compar']]]
print(df_GL55)
...
xp='GN84'
df_GN84=df_an.loc[((df_an['expe']==xp) & (df_new['var']==niv))][['date','expe','var','level','biais','eqm','ech','zone','compar']]
print(df_GN84)
...
xp='GO4A'
df_GO4A=df_new.loc[((df_new['expe']==xp) & (df_new['var']==niv))][['date','expe','var','level','biais','eqm','ech','zone','compar']]
print(df_GO4A)
...
plt.suptitle('Analysed SST - Instantaneous Mercator SST (REF) ',fontsize=26, y=0.95)
...
df_new = pd.read_csv('DF_SST_8/'+str(zone)+str(compar)+'_sst.csv')
df_new.head()
df_new.dtypes
...
# df_GK7C = pd.read_csv('DF_SST_decembre/septembre_octobre_double_'+str(compar)+'_sst_'+str(zone_GK7C)+'_'+str(cterm)+'.csv')
# df_GK7C.head()
# df_GK7C.dtypes
...
df_GKCJ = pd.read_csv('DF_SST_decembre/septembre_octobre_double_GKCJ_prev-mer_sst_eurat_0.csv')
df_GKCJ.head()
df_GKCJ.dtypes
...
plt.suptitle('96-h forecasted SST - Instantaneous Mercator SST (REF)',fontsize=26, y=0.95)
...
ax[1].plot(df_GKCJ.date,df_GKCJ.eqm,label='MERCATOR moyen',color=color_GKCJ,linewidth=3)
# ax[1].legend(['L.12','L.26','R.50','no.curr','no.curr.bathy', 'Xp.finale','SST.cst.mer'],fontsize=14, loc='upper right')
ax[1].legend(['L.26','Xp.finale','GO4A','oper.2024'],fontsize=19, loc='upper right')
plt.show()
