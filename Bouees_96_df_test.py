...
pathres="/home/ormieresl/Routines/bouees/DF_bouees_96h_2"
...
raw_data1 =      {'biais_obs': [''],
                 'lon': [''],
                 'lat': ['']}
df_diff_day = pd.DataFrame(raw_data1, columns = ['biais_obs','lon','lat'])
...
for e in range(len(expe)):
    ...
    for t in range(nb):
        ...
        # =============================================================================
            ...
            # lon_mask=df_bouees.lon[i]
            # lat_mask=df_bouees.lat[i]
            # mask=(lon_expe==df_bouees.lon[i])&(lat_expe==df_bouees.lat[i])
            # mask=(lon_expe:=5)
            # SST_2=x.data[mask]
            # print('SST_2',SST_2)
            # print(SST) 
        ...
        df_diff_day.drop(index=df_diff_day.index[0], axis=0, inplace=True) # delter firt row
