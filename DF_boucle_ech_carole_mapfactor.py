...
pathres = '/home/ormieresl/Routines/DF_ech_vf_mapfactor/'
                ...
                try:
                    ...
                    for i in range(len(name)):
                        ...
                        for key in zones.keys():
                          ...
                          #temp
                          temp_exp_mean  = sgmeandm(temp_exp.data,map_factor,mask)
                          temp_merc_mean = sgmeandm(temp_merc.data,map_factor,mask)
