...
dir_fig='/cnrm/recyf/Data/users/ormieresl/plot_evol_sst/plot_evol_sst_v1/'
#%%
...
for izone, zone in enumerate(zone):
    ...
    ax2.set_ylabel('Nb_points',color='grey', fontsize=22)
    ...
    ax[1].legend(['L.26','L.12','R.50','Xp.finale','Xp.buyos','Xp.R10x4','oper.2024'],fontsize=19,bbox_to_anchor=(1.1, 1.05))
